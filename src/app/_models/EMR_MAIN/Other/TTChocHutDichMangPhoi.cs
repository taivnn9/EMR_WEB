...
{
    public class TTChocHutDichMangPhoi : ThongTinKy
    {
        public TTChocHutDichMangPhoi()
        {
            TableName = "TTChocHutDichMangPhoi";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.TTCHDMP;
            TenMauPhieu = DanhMucPhieu.TTCHDMP.Description();
        }
        ...
        public string SatTrungViTri { get; set; }
        public string ViTriTe { get; set; }
    ...
    public class TTChocHutDichMangPhoiFunc
    {
        public const string TableName = "TTChocHutDichMangPhoi";
        public const string TablePrimaryKeyName = "ID";

        public static List<TTChocHutDichMangPhoi> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<TTChocHutDichMangPhoi> list = new List<TTChocHutDichMangPhoi>();
            try
            {
                string sql = @"SELECT * FROM TTChocHutDichMangPhoi where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    TTChocHutDichMangPhoi data = new TTChocHutDichMangPhoi();
                    ...
                    data.SatTrungViTri = DataReader["SatTrungViTri"].ToString();
                    data.ViTriTe = DataReader["ViTriTe"].ToString();
        ...
        public static bool DeleteByIDPhieu(MDB.MDBConnection oracleConnection, decimal IDBienBan)
        {
            try
            {
                ...
                string sql = @"DELETE FROM TTChocHutDichMangPhoi WHERE ID =" + IDBienBan;
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref TTChocHutDichMangPhoi ketQua)
        {
            try
            {
                string sql = @"INSERT INTO TTChocHutDichMangPhoi
                (
                    MaQuanLy,
                    Buong,
                    Giuong,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE TTChocHutDichMangPhoi SET 
                    MaQuanLy = :MaQuanLy,
                    Buong = :Buong,
                    Giuong = :Giuong,
                ...
                Command.Parameters.Add(new MDB.MDBParameter("SatTrungViTri", ketQua.SatTrungViTri));
                Command.Parameters.Add(new MDB.MDBParameter("ViTriTe", ketQua.ViTriTe));
