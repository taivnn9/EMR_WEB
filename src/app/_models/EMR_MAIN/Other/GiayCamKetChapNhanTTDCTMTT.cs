...
{
    public class GiayCamKetChapNhanTTDCTMTT : ThongTinKy
    {
        public GiayCamKetChapNhanTTDCTMTT()
        {
            TableName = "GiayCamKetChapNhanTTDCTMTT";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCKCNTTDCTMTT;
            TenMauPhieu = DanhMucPhieu.GCKCNTTDCTMTT.Description();
        }
    ...
    public class GiayCamKetChapNhanTTDCTMTTFunc
    {
        public const string TableName = "GiayCamKetChapNhanTTDCTMTT";
        ...
        public static bool Delete(MDB.MDBConnection MyConnection, decimal id)
        {
            try
            {
                string sql = "DELETE FROM GiayCamKetChapNhanTTDCTMTT WHERE ID = :ID";
        ...
        {
            string sql = @"select * "
                         + " from GiayCamKetChapNhanTTDCTMTT WHERE ID =: ID ORDER BY NgayTao, NgaySua asc";
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, GiayCamKetChapNhanTTDCTMTT ketQua)
        {
            try
            {
                string sql = @"INSERT INTO GiayCamKetChapNhanTTDCTMTT
                (
                    MaQuanLy,
                    MaBenhNhan,
                    MaBenhAn,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE GiayCamKetChapNhanTTDCTMTT SET 
                    MaQuanLy = :MaQuanLy,
                    ...
                    DiaChi = :DiaChi,
                    HoVaTen = :HoVaTen,
                    NamSinhNguoiThan = :NamSinhNguoiThan,
                ...
                Command.Parameters.Add(new MDB.MDBParameter("NamSinhNguoiThan", ketQua.NamSinhNguoiThan));
                Command.Parameters.Add(new MDB.MDBParameter("DiaChiNguoiThan", ketQua.DiaChiNguoiThan));
        ...
        public static List<GiayCamKetChapNhanTTDCTMTT> GetListData(MDB.MDBConnection MyConnection, decimal MaQuanLy)
        {
            List<GiayCamKetChapNhanTTDCTMTT> lstData = new List<GiayCamKetChapNhanTTDCTMTT>();
            string sql = @"select * from GiayCamKetChapNhanTTDCTMTT WHERE MaQuanLy = :MaQuanLy ";
            ...
            {
                GiayCamKetChapNhanTTDCTMTT data = new GiayCamKetChapNhanTTDCTMTT();
                ...
                data.NamSinhNguoiThan = DataReader["NamSinhNguoiThan"].ToString();
                data.DiaChiNguoiThan = DataReader["DiaChiNguoiThan"].ToString();
