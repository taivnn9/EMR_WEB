...
{
    public class NguoiNhaCamDoanSDTTDT : ThongTinKy
    {
        public NguoiNhaCamDoanSDTTDT()
        {
            TableName = "NguoiNhaCamDoanSDTTDT";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCDCNSDTTDTCNN;
            TenMauPhieu = DanhMucPhieu.GCDCNSDTTDTCNN.Description();
        }
    ...
    public class NguoiNhaCamDoanSDTTDTFunc
    {
        public const string TableName = "NguoiNhaCamDoanSDTTDT";
        public const string TablePrimaryKeyName = "ID";
        public static List<NguoiNhaCamDoanSDTTDT> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<NguoiNhaCamDoanSDTTDT> list = new List<NguoiNhaCamDoanSDTTDT>();
            try
            {
                string sql = @"SELECT * FROM NguoiNhaCamDoanSDTTDT where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    NguoiNhaCamDoanSDTTDT obj = new NguoiNhaCamDoanSDTTDT();
                    ...
                    obj.TenToiLa = Common.ConDBNull(DataReader["TenToiLa"]);
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref NguoiNhaCamDoanSDTTDT obj)
        {
            try
            {
                string sql = @"INSERT INTO NguoiNhaCamDoanSDTTDT
                (
                    MaQuanLy,
                    MaBenhNhan,
                    TenToiLa,
                ...
                if (obj.ID != 0)
                {
                    sql = @"UPDATE NguoiNhaCamDoanSDTTDT SET 
                    MaQuanLy=:MaQuanLy,
                ...
                oracleCommand.Parameters.Add(new MDB.MDBParameter("TenToiLa", obj.TenToiLa));
        ...
        public static bool delete(MDB.MDBConnection MyConnection, decimal id)
        {
            try
            {
                string sql = "DELETE FROM NguoiNhaCamDoanSDTTDT WHERE ID = :ID";
