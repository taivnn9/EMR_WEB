...
{
    public class ThangTramCamHamilton : ThongTinKy
    {
        public ThangTramCamHamilton()
        {
            TableName = "ThangTramCamHamilton";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.TTCH;
            TenMauPhieu = DanhMucPhieu.TTCH.Description();
        }
        ...
        public bool[] STT_1_Array { get; } = new bool[] { false, false, false, false, false };
        public int STT_1
        {
            get
            {
        ...
        public bool[] STT_4_Array { get; } = new bool[] { false, false, false};
        public int STT_4
        {
            get
            {
        ...
        public bool[] STT_8_Array { get; } = new bool[] { false, false, false, false, false };
        public int STT_8
        {
            get
            {
        ...
        public bool[] STT_9_Array { get; } = new bool[] { false, false, false, false, false };
        public int STT_9
        {
            get
            {
        ...
        public bool[] STT_10_Array { get; } = new bool[] { false, false, false, false, false};
        public int STT_10
        {
            get
            {
        ...
        public bool[] STT_11_Array { get; } = new bool[] { false, false, false, false, false };
        public int STT_11
        {
            get
            {
        ...
        public bool[] STT_12_Array { get; } = new bool[] { false, false, false };
        public int STT_12
        {
            get
            {
        ...
        public bool[] STT_13_Array { get; } = new bool[] { false, false, false };
        public int STT_13
        {
            get
            {
        ...
        public bool[] STT_14_Array { get; } = new bool[] { false, false, false };
        public int STT_14
        {
            get
            {
        ...
        public bool[] STT_15_Array { get; } = new bool[] { false, false, false, false, false };
        public int STT_15
        {
            get
            {
        ...
        public bool[] STT_16_Array { get; } = new bool[] { false, false, false };
        public int STT_16
        {
            get
            {
        ...
        public bool[] STT_17_Array { get; } = new bool[] { false, false, false};
        public int STT_17
        {
            get
            {
        ...
        public bool[] STT_18_Array { get; } = new bool[] { false, false, false};
        public int STT_18
        {
            get
            {
        ...
        public bool[] STT_19_Array { get; } = new bool[] { false, false, false };
        public int STT_19
        {
            get
            {
        ...
        public bool[] STT_20_Array { get; } = new bool[] { false, false, false, false, false };
        public int STT_20
        {
            get
            {
        ...
        public bool[] STT_21_Array { get; } = new bool[] { false, false, false, false, false };
        public int STT_21
        {
            get
            {
    ...
    public class ThangTramCamHamiltonFunc
    {
        public const string TableName = "ThangTramCamHamilton";
        public const string TablePrimaryKeyName = "ID";
        public static List<ThangTramCamHamilton> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<ThangTramCamHamilton> list = new List<ThangTramCamHamilton>();
            try
            {
                string sql = @"SELECT * FROM ThangTramCamHamilton where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    ThangTramCamHamilton data = new ThangTramCamHamilton();
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref ThangTramCamHamilton ketQua)
        {
            try
            {
                string sql = @"INSERT INTO ThangTramCamHamilton
                (
                    MAQUANLY,
                    MaBenhNhan,
                    ChanDoan,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE ThangTramCamHamilton SET 
                    MAQUANLY = :MAQUANLY,
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM ThangTramCamHamilton WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
