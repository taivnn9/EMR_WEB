...
{
    public class ChiTietBang // set lại binding đoạn này lên giao diện file xaml nhé
    {
    ...
    public class BangKeThuocDungTrongGayMe : ThongTinKy
    {
        public BangKeThuocDungTrongGayMe()
        {
            TableName = "BangKeThuocDungTrongGayMe";
        ...
        public ObservableCollection<ChiTietBang> ThuocVatTus { get; set; }
    ...
    public class BangKeThuocDungTrongGayMeFunc
    {
        public const string TableName = "BangKeThuocDungTrongGayMe";
        public const string TablePrimaryKeyName = "ID";
        public static List<BangKeThuocDungTrongGayMe> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<BangKeThuocDungTrongGayMe> list = new List<BangKeThuocDungTrongGayMe>();
            try
            {
                string sql = @"SELECT * FROM BangKeThuocDungTrongGayMe where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    BangKeThuocDungTrongGayMe data = new BangKeThuocDungTrongGayMe();
                    ...
                    if (DataReader["ThuocGayMe_3"] != DBNull.Value)
                        bangKeJson += DataReader["ThuocGayMe_3"].ToString();
                    data.ThuocVatTus = JsonConvert.DeserializeObject<ObservableCollection<ChiTietBang>>(bangKeJson);
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref BangKeThuocDungTrongGayMe bangKe)
        {
            try
            {
                string sql = @"INSERT INTO BangKeThuocDungTrongGayMe
                (
                    MAQUANLY,
                    MaBenhNhan,
                    KipPhauThuat, 
                ...
                if (bangKe.ID != 0)
                {
                    sql = @"UPDATE BangKeThuocDungTrongGayMe SET 
                    MAQUANLY = :MAQUANLY,
                ...
                Command.Parameters.Add(new MDB.MDBParameter("ThuocGayMe_3", listJson.Count > 1 ? listJson[1] : null));
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM BangKeThuocDungTrongGayMe WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
        ...
        public static DataSet getDataSet(MDB.MDBConnection MyConnection, long id)
        {
            ...
            sql = @"SELECT B.ThuocGayMe_1, B.ThuocGayMe_2, B.ThuocGayMe_3
            FROM
                BangKeThuocDungTrongGayMe B
            ...
            ObservableCollection<ChiTietBang> saveDatas = new ObservableCollection<ChiTietBang>();
            while (DataReader.Read())
            {
                string bangKeJson = DataReader["ThuocGayMe_1"].ToString();
                ...
                if (DataReader["ThuocGayMe_2"] != DBNull.Value)
                    bangKeJson += DataReader["ThuocGayMe_3"].ToString();
                saveDatas = JsonConvert.DeserializeObject<ObservableCollection<ChiTietBang>>(bangKeJson);
                break;
            }
