...
{
    public class GiayCamDoanChapNhanTTCTTMC : ThongTinKy
    {
        public GiayCamDoanChapNhanTTCTTMC()
        {
            TableName = "GiayCamDoanChapNhanTTCTTMC";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCDCNTTCTTMC;
            TenMauPhieu = DanhMucPhieu.GCDCNTTCTTMC.Description();
        }
    ...
    public class GiayCamDoanChapNhanTTCTTMCFunc
    {
        public const string TableName = "GiayCamDoanChapNhanTTCTTMC";
        public const string TablePrimaryKeyName = "ID";
        public const string MaPhieu = "GCDCNTTCTTMC";

        public static bool Delete(MDB.MDBConnection MyConnection, decimal id)
        {
            try
            {
                string sql = "DELETE FROM GiayCamDoanChapNhanTTCTTMC WHERE ID = :ID";
        ...
        {
            string sql = @"select * "
                         + " from GiayCamDoanChapNhanTTCTTMC WHERE ID =: ID ORDER BY NgayTao, NgaySua asc";
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, GiayCamDoanChapNhanTTCTTMC ketQua)
        {
            try
            {
                string sql = @"INSERT INTO GiayCamDoanChapNhanTTCTTMC
                (
                    MaQuanLy,
                    MaBenhNhan,
                    MaBenhAn,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE GiayCamDoanChapNhanTTCTTMC SET 
                    MaQuanLy = :MaQuanLy,
        ...
        public static List<GiayCamDoanChapNhanTTCTTMC> GetListData(MDB.MDBConnection MyConnection, decimal MaQuanLy)
        {
            List<GiayCamDoanChapNhanTTCTTMC> lstData = new List<GiayCamDoanChapNhanTTCTTMC>();
            string sql = @"select * from GiayCamDoanChapNhanTTCTTMC WHERE MaQuanLy = :MaQuanLy ";
            ...
            {
                GiayCamDoanChapNhanTTCTTMC data = new GiayCamDoanChapNhanTTCTTMC();
