...
{
    public class DanhGiaNguoiBenhNhapVien : ThongTinKy
    {
        public DanhGiaNguoiBenhNhapVien()
        {
            TableName = "DanhGiaNguoiBenhNhapVien";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.DGNBNV;
            TenMauPhieu = DanhMucPhieu.DGNBNV.Description();
        }
        ...
        public bool[] BaiTietTieuTienArray { get; } = new bool[] { false, false, false, false, false };
        ...
        public bool[] BaiTietDaiTienArray { get; } = new bool[] { false, false, false, false, false, false };
        ...
        public bool[] AnKiengArray { get; } = new bool[] { false, false, false, false, false, false };
        public string AnKieng
        {
            get
            {
                string temp = String.Empty;
                for (int i = 0; i < AnKiengArray.Length; i++)
                    temp += (AnKiengArray[i] ? "1" : "0");
                return temp;
            }
            set
            {
                if (value != null)
                {
                    ...
                    {
                        int intTemp = value[i] - '0';
                        AnKiengArray[i] = intTemp == 1 ? true : false;
                    }
                }
            }
        }
        public string AnKieng_Khac { get; set; }
        public string AnKieng_ThoiGianPhatHien { get; set; }
        public string AnKieng_CheDoTT { get; set; }
        public string AnKieng_CheDoDB { get; set; }
        public string AnKieng_TuVanCheDo { get; set; }
    ...
    public class DanhGiaNguoiBenhNhapVienFunc
    {
        public const string TableName = "DanhGiaNguoiBenhNhapVien";
        public const string TablePrimaryKeyName = "ID";
        public static List<DanhGiaNguoiBenhNhapVien> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<DanhGiaNguoiBenhNhapVien> list = new List<DanhGiaNguoiBenhNhapVien>();
            try
            {

                string sql = @"SELECT * FROM DANHGIANGUOIBENHNHAPVIEN where MaQuanLy = :MaQuanLy";
                ...
                while (DataReader.Read())
                {
                    try
                    {
                        DanhGiaNguoiBenhNhapVien data = new DanhGiaNguoiBenhNhapVien();
                        ...
                        data.NgheNghiep = DataReader.GetInt("NgheNghiep");
                        ...
                        data.BMI = DataReader["BMI"] != DBNull.Value ? DataReader["BMI"].ToString() : "";
                        ...
                        data.NgayDatOngThongTieu = DataReader["NgayDatOngThongTieu"] != DBNull.Value ? (DateTime?) ConDB_DateTime(DataReader["NgayDatOngThongTieu"]): null;
                        ...
                        data.AnKieng = DataReader["AnKieng"] != DBNull.Value ? DataReader["AnKieng"].ToString() : "";
                        data.AnKieng_Khac = DataReader["AnKieng_Khac"] != DBNull.Value ? DataReader["AnKieng_Khac"].ToString() : "";
                        data.AnKieng_ThoiGianPhatHien = DataReader["AnKieng_ThoiGianPhatHien"] != DBNull.Value ? DataReader["AnKieng_ThoiGianPhatHien"].ToString() : "";
                        data.AnKieng_CheDoTT = DataReader["AnKieng_CheDoTT"] != DBNull.Value ? DataReader["AnKieng_CheDoTT"].ToString() : "";
                        data.AnKieng_CheDoDB = DataReader["AnKieng_CheDoDB"] != DBNull.Value ? DataReader["AnKieng_CheDoDB"].ToString() : "";
                        data.AnKieng_TuVanCheDo = DataReader["AnKieng_TuVanCheDo"] != DBNull.Value ? DataReader["AnKieng_TuVanCheDo"].ToString() : "";
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref DanhGiaNguoiBenhNhapVien objData)
        {
            string sql;
            int n = 0;
            if (objData.ID == 0)
            {
                sql = @"INSERT INTO DANHGIANGUOIBENHNHAPVIEN (
                        maquanly,
                        mabenhnhan,
                        tenbenhnhan,
                        tuoi,
                ...
                Command.Parameters.Add(new MDB.MDBParameter("ankieng", objData.AnKieng));
                Command.Parameters.Add(new MDB.MDBParameter("ankieng_khac", objData.AnKieng_Khac));
                Command.Parameters.Add(new MDB.MDBParameter("ankieng_thoigianphathien", objData.AnKieng_ThoiGianPhatHien));
                Command.Parameters.Add(new MDB.MDBParameter("ankieng_chedott", objData.AnKieng_CheDoTT));
                Command.Parameters.Add(new MDB.MDBParameter("ankieng_chedodb", objData.AnKieng_CheDoDB));
                Command.Parameters.Add(new MDB.MDBParameter("ankieng_tuvanchedo", objData.AnKieng_TuVanCheDo));
            ...
            {
                sql = @"UPDATE DANHGIANGUOIBENHNHAPVIEN SET 
                                        maquanly=:maquanly,
                                        ...
                                        ankieng=:ankieng,
                                        ankieng_khac=:ankieng_khac,
                                        ankieng_thoigianphathien=:ankieng_thoigianphathien,
                                        ankieng_chedott=:ankieng_chedott,
                                        ankieng_chedodb=:ankieng_chedodb,
                                        ankieng_tuvanchedo=:ankieng_tuvanchedo,
        ...
        {
            string sql = "DELETE FROM DANHGIANGUOIBENHNHAPVIEN WHERE ID = :idPhieu";
        ...
        public static DanhGiaNguoiBenhNhapVien GetData(MDB.MDBConnection _OracleConnection, decimal id)
        {
            try
            {
                string sql = @"SELECT * FROM DANHGIANGUOIBENHNHAPVIEN where ID = :ID";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
