...
{
    public class ThuThuatRutChiThep : ThongTinKy
    {
        public ThuThuatRutChiThep()
        {
            TableName = "ThuThuatRutChiThep";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.TTRCT;
            TenMauPhieu = DanhMucPhieu.TTRCT.Description();
        }
    ...
    public class ThuThuatRutChiThepFunc
    {
        public const string TableName = "ThuThuatRutChiThep";
        public const string TablePrimaryKeyName = "ID";

        public static List<ThuThuatRutChiThep> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<ThuThuatRutChiThep> list = new List<ThuThuatRutChiThep>();
            try
            {
                string sql = @"SELECT * FROM ThuThuatRutChiThep where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    ThuThuatRutChiThep data = new ThuThuatRutChiThep();
        ...
        public static bool DeleteByIDPhieu(MDB.MDBConnection oracleConnection, decimal IDBienBan)
        {
            try
            {
                ...
                string sql = @"DELETE FROM ThuThuatRutChiThep WHERE ID =" + IDBienBan;
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref ThuThuatRutChiThep ketQua)
        {
            try
            {
                string sql = @"INSERT INTO ThuThuatRutChiThep
                (
                    MaQuanLy,
                    Buong,
                    Giuong,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE ThuThuatRutChiThep SET 
                    MaQuanLy = :MaQuanLy,
                    Buong = :Buong,
                    Giuong = :Giuong,
