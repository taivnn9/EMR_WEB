...
{
    public class BangKiemTranhNhamLanBenhNhan2 : ThongTinKy
    {
        public BangKiemTranhNhamLanBenhNhan2()
        {
            TableName = "BangKiemTranhNhamLanBN2";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.BKTNLBNKCCDV;
            TenMauPhieu = DanhMucPhieu.BKTNLBNKCCDV.Description();
        }
    ...
    public class BangKiemTranhNhamLanBenhNhan2Func
    {
        public const string TableName = "BangKiemTranhNhamLanBN2";
        public const string TablePrimaryKeyName = "ID";
        public static List<BangKiemTranhNhamLanBenhNhan2> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<BangKiemTranhNhamLanBenhNhan2> list = new List<BangKiemTranhNhamLanBenhNhan2>();
            try
            {
                string sql = @"SELECT * FROM BangKiemTranhNhamLanBN2 where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    BangKiemTranhNhamLanBenhNhan2 data = new BangKiemTranhNhamLanBenhNhan2();
                    ...
                    data.NgayKy = Convert.ToDateTime(DataReader["NgayKy"] == DBNull.Value ? DateTime.Now : DataReader["NgayKy"]);
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref BangKiemTranhNhamLanBenhNhan2 bangKiem)
        {
            try
            {
                string sql = @"INSERT INTO BangKiemTranhNhamLanBN2
                (
                    MAQUANLY,
                    MaBenhNhan,
                    Ten1,
                ...
                if (bangKiem.ID != 0)
                {
                    sql = @"UPDATE BangKiemTranhNhamLanBN2 SET 
                    MAQUANLY = :MAQUANLY,
                ...
                Command.Parameters.Add(new MDB.MDBParameter("NGAYKY", bangKiem.NgayKy));
                if (bangKiem.ID == 0)
                {
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM BangKiemTranhNhamLanBN2 WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
