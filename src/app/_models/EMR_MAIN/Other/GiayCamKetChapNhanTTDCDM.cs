...
{
    public class GiayCamKetChapNhanTTDCDM : ThongTinKy
    {
        public GiayCamKetChapNhanTTDCDM()
        {
            TableName = "GiayCamKetChapNhanTTDCDM";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCKCNTTDCDM;
            TenMauPhieu = DanhMucPhieu.GCKCNTTDCDM.Description();
        }
    ...
    public class GiayCamKetChapNhanTTDCDMFunc
    {
        public const string TableName = "GiayCamKetChapNhanTTDCDM";
        public const string TablePrimaryKeyName = "ID";
        public const string MaPhieu = "GCKCNTTDCDM";

        public static bool Delete(MDB.MDBConnection MyConnection, decimal id)
        {
            try
            {
                string sql = "DELETE FROM GiayCamKetChapNhanTTDCDM WHERE ID = :ID";
        ...
        {
            string sql = @"select * "
                         + " from GiayCamKetChapNhanTTDCDM WHERE ID =: ID ORDER BY NgayTao, NgaySua asc";
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, GiayCamKetChapNhanTTDCDM ketQua)
        {
            try
            {
                string sql = @"INSERT INTO GiayCamKetChapNhanTTDCDM
                (
                    MaQuanLy,
                    MaBenhNhan,
                    MaBenhAn,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE GiayCamKetChapNhanTTDCDM SET 
                    MaQuanLy = :MaQuanLy,
        ...
        public static List<GiayCamKetChapNhanTTDCDM> GetListData(MDB.MDBConnection MyConnection, decimal MaQuanLy)
        {
            List<GiayCamKetChapNhanTTDCDM> lstData = new List<GiayCamKetChapNhanTTDCDM>();
            string sql = @"select * from GiayCamKetChapNhanTTDCDM WHERE MaQuanLy = :MaQuanLy ";
            ...
            {
                GiayCamKetChapNhanTTDCDM data = new GiayCamKetChapNhanTTDCDM();
