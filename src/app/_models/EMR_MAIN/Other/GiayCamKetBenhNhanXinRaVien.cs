...
{
    public class GiayCamKetBenhNhanXinRaVien : ThongTinKy
    {
        public GiayCamKetBenhNhanXinRaVien()
        {
            TableName = "GiayCamKetBenhNhanXinRaVien";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCKBNXRV;
            TenMauPhieu = DanhMucPhieu.GCKBNXRV.Description();
        }
    ...
    public class GiayCamKetBenhNhanXinRaVienFunc
    {
        public const string TableName = "GiayCamKetBenhNhanXinRaVien";
        public const string TablePrimaryKeyName = "ID";
        public const string MaPhieu = "GCKBNXRV";

        public static bool Delete(MDB.MDBConnection MyConnection, decimal id)
        {
            try
            {
                string sql = "DELETE FROM GiayCamKetBenhNhanXinRaVien WHERE ID = :ID";
        ...
        {
            string sql = @"select * "
                         + " from GiayCamKetBenhNhanXinRaVien WHERE ID =: ID ORDER BY NgayTao, NgaySua asc";
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, GiayCamKetBenhNhanXinRaVien ketQua)
        {
            try
            {
                string sql = @"INSERT INTO GiayCamKetBenhNhanXinRaVien
                (
                    MaQuanLy,
                    MaBenhNhan,
                    MaBenhAn,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE GiayCamKetBenhNhanXinRaVien SET 
                    MaQuanLy = :MaQuanLy,
        ...
        public static List<GiayCamKetBenhNhanXinRaVien> GetListData(MDB.MDBConnection MyConnection, decimal MaQuanLy)
        {
            List<GiayCamKetBenhNhanXinRaVien> lstData = new List<GiayCamKetBenhNhanXinRaVien>();
            string sql = @"select * from GiayCamKetBenhNhanXinRaVien WHERE MaQuanLy = :MaQuanLy ";
            ...
            {
                GiayCamKetBenhNhanXinRaVien data = new GiayCamKetBenhNhanXinRaVien();
