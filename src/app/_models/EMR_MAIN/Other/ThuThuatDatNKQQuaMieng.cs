...
{
    public class ThuThuatDatNKQQuaMieng : ThongTinKy
    {
        public ThuThuatDatNKQQuaMieng()
        {
            TableName = "ThuThuatDatNKQQuaMieng";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.PTTTDNKQQMIENG;
            TenMauPhieu = DanhMucPhieu.PTTTDNKQQMIENG.Description();
        }
    ...
    public class ThuThuatDatNKQQuaMiengFunc
    {
        public const string TableName = "ThuThuatDatNKQQuaMieng";
        public const string TablePrimaryKeyName = "ID";

        public static List<ThuThuatDatNKQQuaMieng> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<ThuThuatDatNKQQuaMieng> list = new List<ThuThuatDatNKQQuaMieng>();
            try
            {
                string sql = @"SELECT * FROM ThuThuatDatNKQQuaMieng where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    ThuThuatDatNKQQuaMieng data = new ThuThuatDatNKQQuaMieng();
        ...
        public static bool DeleteByIDPhieu(MDB.MDBConnection oracleConnection, decimal IDBienBan)
        {
            try
            {
                ...
                string sql = @"DELETE FROM ThuThuatDatNKQQuaMieng WHERE ID =" + IDBienBan;
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref ThuThuatDatNKQQuaMieng ketQua)
        {
            try
            {
                string sql = @"INSERT INTO ThuThuatDatNKQQuaMieng
                (
                    MaQuanLy,
                    Buong,
                    Giuong,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE ThuThuatDatNKQQuaMieng SET 
                    MaQuanLy = :MaQuanLy,
                    Buong = :Buong,
                    Giuong = :Giuong,
