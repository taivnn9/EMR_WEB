...
{
    public class TaiKhamBATMCoTimCucBo : ThongTinKy
    {
        public TaiKhamBATMCoTimCucBo()
        {
            TableName = "TaiKhamBATMCoTimCucBo";
    ...
    public class TaiKhamBATMCoTimCucBoFunc
    {
        public const string TableName = "TaiKhamBATMCoTimCucBo";
        public const string TablePrimaryKeyName = "ID";
        public static List<TaiKhamBATMCoTimCucBo> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<TaiKhamBATMCoTimCucBo> list = new List<TaiKhamBATMCoTimCucBo>();
            try
            {
                string sql = @"SELECT * FROM TaiKhamBATMCoTimCucBo where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    TaiKhamBATMCoTimCucBo data = new TaiKhamBATMCoTimCucBo();
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref TaiKhamBATMCoTimCucBo ketQua)
        {
            try
            {
                string sql = @"INSERT INTO TaiKhamBATMCoTimCucBo
                (
                    MAQUANLY,
                    MaBenhNhan,
                    TaiKhamLan,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE TaiKhamBATMCoTimCucBo SET 
                    MAQUANLY = :MAQUANLY,
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM TaiKhamBATMCoTimCucBo WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
