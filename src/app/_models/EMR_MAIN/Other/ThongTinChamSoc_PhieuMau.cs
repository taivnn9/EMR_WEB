...
{
    public class ThongTinChamSoc_PhieuMau
    {
    ...
    public class ThongTinChamSoc_PhieuMauFunc
    {
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ThongTinChamSoc_PhieuMau data)
        {
            string sqlSearch = @"SELECT * FROM THONGTINCHAMSOC_PHIEUMAU WHERE MANHANVIEN = :MANHANVIEN AND MAPHIEUMAU = :MAPHIEUMAU";
            ...
            if (count > 0)
            {
                sql = "UPDATE THONGTINCHAMSOC_PHIEUMAU SET"
            ...
            {
                sql = "INSERT INTO THONGTINCHAMSOC_PHIEUMAU"
        ...
        {
            string sql = @"DELETE FROM THONGTINCHAMSOC_PHIEUMAU WHERE MANHANVIEN = :MANHANVIEN AND MAPHIEUMAU = :MAPHIEUMAU";
        ...
        {
            string sql = @"DELETE FROM THONGTINCHAMSOC_PHIEUMAU WHERE MANHANVIEN = :MANHANVIEN";
            MDB.MDBCommand cmd = new MDB.MDBCommand(sql, MyConnection);
            cmd.Parameters.Add(new MDB.MDBParameter("MANHANVIEN", MaNhanVien));
            return cmd.ExecuteNonQuery() > 0;
        }
        public static int GetLatestID(MDB.MDBConnection MyConnection, string MaNhanVien)
        {
            try
            {
                string sql = string.Format("SELECT * FROM ({0}) WHERE ROWNUM = 1",
                    "SELECT MAPHIEUMAU FROM THONGTINCHAMSOC_PHIEUMAU WHERE MANHANVIEN = :MANHANVIEN ORDER BY MAPHIEUMAU DESC");
                MDB.MDBCommand cmd = new MDB.MDBCommand(sql, MyConnection);
                cmd.Parameters.Add(new MDB.MDBParameter("MANHANVIEN", MaNhanVien));
        ...
        public static List<ThongTinChamSoc_PhieuMau> GetData(MDB.MDBConnection MyConnection, string MaNhanVien)
        {
            List<ThongTinChamSoc_PhieuMau> lstData = new List<ThongTinChamSoc_PhieuMau>();
            string sql = "SELECT * FROM THONGTINCHAMSOC_PHIEUMAU WHERE MANHANVIEN = :MANHANVIEN ORDER BY TENPHIEUMAU";
            MDB.MDBCommand cmd = new MDB.MDBCommand(sql, MyConnection);
            cmd.Parameters.Add(new MDB.MDBParameter("MANHANVIEN", MaNhanVien));
            ...
            {
                lstData.Add(new ThongTinChamSoc_PhieuMau
                {
        ...
        public static List<ThongTinChamSoc_PhieuMau> GetData(MDB.MDBConnection MyConnection, string MaNhanVien, string MaPhieuMau)
        {
            List<ThongTinChamSoc_PhieuMau> lstData = new List<ThongTinChamSoc_PhieuMau>();
            string sql = "SELECT * FROM THONGTINCHAMSOC_PHIEUMAU WHERE MANHANVIEN = :MANHANVIEN AND MAPHIEUMAU = :MAPHIEUMAU ORDER BY TENPHIEUMAU";
            MDB.MDBCommand cmd = new MDB.MDBCommand(sql, MyConnection);
            cmd.Parameters.Add(new MDB.MDBParameter("MANHANVIEN", MaNhanVien));
            cmd.Parameters.Add(new MDB.MDBParameter("MAPHIEUMAU", MaPhieuMau));
            MDB.MDBDataReader DataReader = cmd.ExecuteReader();
