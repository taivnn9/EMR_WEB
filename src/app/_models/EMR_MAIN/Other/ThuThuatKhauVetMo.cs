...
{
    public class ThuThuatKhauVetMo : ThongTinKy
    {
        public ThuThuatKhauVetMo()
        {
            TableName = "ThuThuatKhauVetMo";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.TTKVM;
            TenMauPhieu = DanhMucPhieu.TTKVM.Description();
        }
    ...
    public class ThuThuatKhauVetMoFunc
    {
        public const string TableName = "ThuThuatKhauVetMo";
        public const string TablePrimaryKeyName = "ID";

        public static List<ThuThuatKhauVetMo> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<ThuThuatKhauVetMo> list = new List<ThuThuatKhauVetMo>();
            try
            {
                string sql = @"SELECT * FROM ThuThuatKhauVetMo where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    ThuThuatKhauVetMo data = new ThuThuatKhauVetMo();
        ...
        public static bool DeleteByIDPhieu(MDB.MDBConnection oracleConnection, decimal IDBienBan)
        {
            try
            {
                ...
                string sql = @"DELETE FROM ThuThuatKhauVetMo WHERE ID =" + IDBienBan;
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref ThuThuatKhauVetMo ketQua)
        {
            try
            {
                string sql = @"INSERT INTO ThuThuatKhauVetMo
                (
                    MaQuanLy,
                    Buong,
                    Giuong,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE ThuThuatKhauVetMo SET 
                    MaQuanLy = :MaQuanLy,
                    Buong = :Buong,
                    Giuong = :Giuong,
