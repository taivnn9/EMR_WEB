...
{
    public class ChiTietTruyenMauLamSang
    {
    ...
    public class SaveChiTietTruyenMauLamSang
    {
    ...
    public class PhieuTheoDoiTruyenMauLamSang : ThongTinKy
    {
        public PhieuTheoDoiTruyenMauLamSang()
        {
            TableName = "BangTheoDoiTMLS";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.PTDTMLS;
            TenMauPhieu = DanhMucPhieu.PTDTMLS.Description();
        }
    ...
    public class PhieuTheoDoiTruyenMauLamSangFunc
    {
        public const string TableName = "BangTheoDoiTMLS";
        ...
        public static List<PhieuTheoDoiTruyenMauLamSang> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<PhieuTheoDoiTruyenMauLamSang> list = new List<PhieuTheoDoiTruyenMauLamSang>();
            try
            {
                string sql = @"SELECT * FROM BangTheoDoiTMLS where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    PhieuTheoDoiTruyenMauLamSang data = new PhieuTheoDoiTruyenMauLamSang();
                    ...
                    data.PhanUngCheo = DataReader["PhanUngCheo"].ToString();
                    data.BatDauTruyenHoi = DataReader["BatDauTruyenHoi"] != DBNull.Value ? (DateTime?)DataReader.GetDate("BatDauTruyenHoi") : null;
                    ...
                    data.NgungTruyenHoi = DataReader["NgungTruyenHoi"] != DBNull.Value ? (DateTime?)DataReader.GetDate("NgungTruyenHoi") : null;
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref PhieuTheoDoiTruyenMauLamSang bangKe)
        {
            try
            {
                string sql = @"INSERT INTO BangTheoDoiTMLS
                (
                    MAQUANLY,
                    MaBenhNhan,
                    Giuong,
                ...
                if (bangKe.ID != 0)
                {
                    sql = @"UPDATE BangTheoDoiTMLS SET 
                    MAQUANLY = :MAQUANLY,
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM BangTheoDoiTMLS WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
