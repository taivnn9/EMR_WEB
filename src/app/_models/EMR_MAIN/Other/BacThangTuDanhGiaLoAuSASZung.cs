...
{
    public class BacThangTuDanhGiaLoAuSASZung : ThongTinKy
    {
        // bắt buộc tạo contructor
        public BacThangTuDanhGiaLoAuSASZung()
        {
            TableName = "DanhGiaLoAuSasZung";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.BTTDGLASZ;
            TenMauPhieu = DanhMucPhieu.BTTDGLASZ.Description();
        }
        ...
        public bool[] STT_2_Array { get; } = new bool[] { false, false, false, false };
        public int STT_2
        {
            get
            {
        ...
        public bool[] STT_3_Array { get; } = new bool[] { false, false, false, false };
        public int STT_3
        {
            get
            {
        ...
        public bool[] STT_4_Array { get; } = new bool[] { false, false, false, false };
        public int STT_4
        {
            get
            {
        ...
        public bool[] STT_5_Array { get; } = new bool[] { false, false, false, false };
        public int STT_5
        {
            get
            {
        ...
        public bool[] STT_6_Array { get; } = new bool[] { false, false, false, false };
        public int STT_6
        {
            get
            {
        ...
        public bool[] STT_7_Array { get; } = new bool[] { false, false, false, false };
        public int STT_7
        {
            get
            {
        ...
        public bool[] STT_9_Array { get; } = new bool[] { false, false, false, false };
        public int STT_9
        {
            get
            {
        ...
        public bool[] STT_13_Array { get; } = new bool[] { false, false, false, false };
        public int STT_13
        {
            get
            {
        ...
        public bool[] STT_14_Array { get; } = new bool[] { false, false, false, false };
        public int STT_14
        {
            get
            {
        ...
        public bool[] STT_15_Array { get; } = new bool[] { false, false, false, false };
        public int STT_15
        {
            get
            {
        ...
        public bool[] STT_16_Array { get; } = new bool[] { false, false, false, false };
        public int STT_16
        {
            get
            {
        ...
        public bool[] STT_17_Array { get; } = new bool[] { false, false, false, false };
        public int STT_17
        {
            get
            {
        ...
        public bool[] STT_18_Array { get; } = new bool[] { false, false, false, false };
        public int STT_18
        {
            get
            {
        ...
        public bool[] STT_19_Array { get; } = new bool[] { false, false, false, false };
        public int STT_19
        {
            get
            {
        ...
        public bool[] STT_20_Array { get; } = new bool[] { false, false, false, false };
        public int STT_20
        {
            get
            {
        ...
        [MoTaDuLieu("Họ tên người làm test")]
        public string NguoiLamTest { get; set; }
        [MoTaDuLieu("Mã người làm test")]
    ...
    public class BacThangTuDanhGiaLoAuSASZungFunc
    {
        public const string TableName = "DanhGiaLoAuSasZung";
        public const string TablePrimaryKeyName = "ID";
        public static List<BacThangTuDanhGiaLoAuSASZung> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<BacThangTuDanhGiaLoAuSASZung> list = new List<BacThangTuDanhGiaLoAuSASZung>();
            try
            {
                string sql = @"SELECT * FROM DanhGiaLoAuSasZung where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    BacThangTuDanhGiaLoAuSASZung data = new BacThangTuDanhGiaLoAuSASZung();
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref BacThangTuDanhGiaLoAuSASZung ketQua)
        {
            try
            {
                string sql = @"INSERT INTO DanhGiaLoAuSasZung
                (
                    MAQUANLY,
                    MaBenhNhan,
                    ChanDoan,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE DanhGiaLoAuSasZung SET 
                    MAQUANLY = :MAQUANLY,
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM DanhGiaLoAuSasZung WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
