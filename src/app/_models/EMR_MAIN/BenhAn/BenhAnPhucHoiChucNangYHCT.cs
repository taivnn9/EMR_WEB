...
{
    public class BenhAnPhucHoiChucNangYHCT : BenhAnPhucHoiChucNang
    {
        public BenhAnPhucHoiChucNangYHCT()
        {
            IDMauPhieu = (int)DanhMucPhieu.BAPHCNYHCT;
            TenMauPhieu = DanhMucPhieu.BAPHCNYHCT.Description();
        }
        ...
        public string PhuongPhapDieuTriKetHop { set; get; }
        ...
        public string HOSOKQ_XETNGHIEM { get; set; }
        public string HOSOKQ_SIEUAM { get; set; }
