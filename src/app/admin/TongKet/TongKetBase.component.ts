...
import {TongKet_Sosinh} from './TongKet_Sosinh.component';
        ...
        setTimeout(() => {
            ...
            switch (+this.emrService.ThongTinHoSoBenhAn.LoaiBenhAnEMR) {
                ...
                case LoaiBenhAnEMR.SoSinh:
                    const componentFactorySosinh = this.factoryResolver.resolveComponentFactory(TongKet_Sosinh);
                    this.dynamicInsert.clear();
                    this.dynamicComponent = <TongKet_Sosinh>this.dynamicInsert.createComponent(componentFactorySosinh).instance;
                    break;
                default:
                    break;
            }
