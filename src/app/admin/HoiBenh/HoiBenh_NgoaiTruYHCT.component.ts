...
@Component({
    selector: 'HoiBenh_NgoaiTruYHCT',
    templateUrl: 'HoiBenh_NgoaiTruYHCT.component.html'
})
export class HoiBenh_NgoaiTruYHCT implements OnInit {
    ...
    doCommand(command: number) {
        console.log(`HoiBenh_NgoaiTruYHCT đã nhận được lệnh ${command}`);
        switch (+command) {
            case Command.Save:
                this.save()
                break;
