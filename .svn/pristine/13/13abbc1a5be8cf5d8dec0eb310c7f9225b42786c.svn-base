...
{
    public class BenhAnThieuMauCoTimCucBo : IBase
    {
        public int IDMauPhieu { get; set; } = (int)DanhMucPhieu.TMCTCB;
        public string TenMauPhieu { get; set; } = DanhMucPhieu.TMCTCB.Description();
