...
{
    public class GiayCamKetBenhNhanChuyenVien : ThongTinKy
    {
        public GiayCamKetBenhNhanChuyenVien()
        {
            TableName = "GiayCamKetBenhNhanChuyenVien";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCKBNCV;
            TenMauPhieu = DanhMucPhieu.GCKBNCV.Description();
        }
        ...
        [MoTaDuLieu("Bệnh viện xin chuyển đến")]
        public string BenhVienChuyenDen { get; set; }
        [MoTaDuLieu("Quan hệ với người làm phiếu")]
        public string QuanHeNguoiLamPhieu { get; set; }
        [MoTaDuLieu("Người làm chứng thứ nhất")]
        public string NguoiChungThuNhat { get; set; }
        [MoTaDuLieu("Người làm chứng thứ hai")]
    ...
    public class GiayCamKetBenhNhanChuyenVienFunc
    {
        public const string TableName = "GiayCamKetBenhNhanChuyenVien";
        public const string TablePrimaryKeyName = "ID";
        public const string MaPhieu = "GCKBNCV";

        public static bool Delete(MDB.MDBConnection MyConnection, decimal id)
        {
            try
            {
                string sql = "DELETE FROM GiayCamKetBenhNhanChuyenVien WHERE ID = :ID";
        ...
        {
            string sql = @"select * "
                         + " from GiayCamKetBenhNhanChuyenVien WHERE ID =: ID ORDER BY NgayTao, NgaySua asc";
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, GiayCamKetBenhNhanChuyenVien ketQua)
        {
            try
            {
                string sql = @"INSERT INTO GiayCamKetBenhNhanChuyenVien
                (
                    MaQuanLy,
                    MaBenhNhan,
                    MaBenhAn,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE GiayCamKetBenhNhanChuyenVien SET 
                    MaQuanLy = :MaQuanLy,
                    ...
                    BenhVienChuyenDen = :BenhVienChuyenDen,
                    NGUOISUA = :NGUOISUA,
                    NGAYSUA = :NGAYSUA 
                    WHERE ID = " + ketQua.ID;
                }
                ...
                Command.Parameters.Add(new MDB.MDBParameter("BenhVienChuyenDen", ketQua.BenhVienChuyenDen));
        ...
        public static List<GiayCamKetBenhNhanChuyenVien> GetListData(MDB.MDBConnection MyConnection, decimal MaQuanLy)
        {
            List<GiayCamKetBenhNhanChuyenVien> lstData = new List<GiayCamKetBenhNhanChuyenVien>();
            string sql = @"select * from GiayCamKetBenhNhanChuyenVien WHERE MaQuanLy = :MaQuanLy ";
            ...
            {
                GiayCamKetBenhNhanChuyenVien data = new GiayCamKetBenhNhanChuyenVien();
                ...
                data.BenhVienChuyenDen = DataReader["BenhVienChuyenDen"].ToString();
