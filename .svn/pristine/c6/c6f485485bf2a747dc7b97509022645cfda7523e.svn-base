...
{
    public class ThangDanhGiaTamThanRutGonBPRS : ThongTinKy
    {
        public ThangDanhGiaTamThanRutGonBPRS()
        {
            TableName = "DanhGiaTamThanRutGonBPRS";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.DGBPRS;
            TenMauPhieu = DanhMucPhieu.DGBPRS.Description();
        }
        ...
        public bool[] STT_1_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_1
        {
            get
            {
        ...
        public bool[] STT_2_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_2
        {
            get
            {
        ...
        public bool[] STT_3_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_3
        {
            get
            {
        ...
        public bool[] STT_4_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_4
        {
            get
            {
        ...
        public bool[] STT_5_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_5
        {
            get
            {
        ...
        public bool[] STT_6_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_6
        {
            get
            {
        ...
        public bool[] STT_7_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_7
        {
            get
            {
        ...
        public bool[] STT_8_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_8
        {
            get
            {
        ...
        public bool[] STT_9_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_9
        {
            get
            {
        ...
        public bool[] STT_10_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_10
        {
            get
            {
        ...
        public bool[] STT_11_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_11
        {
            get
            {
        ...
        public bool[] STT_12_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_12
        {
            get
            {
        ...
        public bool[] STT_13_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_13
        {
            get
            {
        ...
        public bool[] STT_14_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_14
        {
            get
            {
        ...
        public bool[] STT_15_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_15
        {
            get
            {
        ...
        public bool[] STT_16_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_16
        {
            get
            {
        ...
        public bool[] STT_17_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_17
        {
            get
            {
        ...
        public bool[] STT_18_Array { get; } = new bool[] { false, false, false, false, false, false, false };
        public int STT_18
        {
            get
            {
    ...
    public class ThangDanhGiaTamThanRutGonBPRSFunc
    {
        public const string TableName = "DanhGiaTamThanRutGonBPRS";
        public const string TablePrimaryKeyName = "ID";
        public static List<ThangDanhGiaTamThanRutGonBPRS> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<ThangDanhGiaTamThanRutGonBPRS> list = new List<ThangDanhGiaTamThanRutGonBPRS>();
            try
            {
                string sql = @"SELECT * FROM DanhGiaTamThanRutGonBPRS where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    ThangDanhGiaTamThanRutGonBPRS data = new ThangDanhGiaTamThanRutGonBPRS();
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref ThangDanhGiaTamThanRutGonBPRS ketQua)
        {
            try
            {
                string sql = @"INSERT INTO DanhGiaTamThanRutGonBPRS
                (
                    MAQUANLY,
                    MaBenhNhan,
                    ChanDoan,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE DanhGiaTamThanRutGonBPRS SET 
                    MAQUANLY = :MAQUANLY,
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM DanhGiaTamThanRutGonBPRS WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
