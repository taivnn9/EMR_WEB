...
{
    public class GiayCamKetChapNhanTTCDMTMP : ThongTinKy
    {
        public GiayCamKetChapNhanTTCDMTMP()
        {
            TableName = "GiayCamKetChapNhanTTCDMTMP";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCKCNTTCDMTMP;
            TenMauPhieu = DanhMucPhieu.GCKCNTTCDMTMP.Description();
        }
        ...
        [MoTaDuLieu("Tên người làm phiếu")]
    ...
    public class GiayCamKetChapNhanTTCDMTMPFunc
    {
        public const string TableName = "GiayCamKetChapNhanTTCDMTMP";
        public const string TablePrimaryKeyName = "ID";
        public const string MaPhieu = "GCKCNTTCDMTMP";

        public static bool Delete(MDB.MDBConnection MyConnection, decimal id)
        {
            try
            {
                string sql = "DELETE FROM GiayCamKetChapNhanTTCDMTMP WHERE ID = :ID";
        ...
        {
            string sql = @"select * "
                         + " from GiayCamKetChapNhanTTCDMTMP WHERE ID =: ID ORDER BY NgayTao, NgaySua asc";
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, GiayCamKetChapNhanTTCDMTMP ketQua)
        {
            try
            {
                string sql = @"INSERT INTO GiayCamKetChapNhanTTCDMTMP
                (
                    MaQuanLy,
                    MaBenhNhan,
                    MaBenhAn,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE GiayCamKetChapNhanTTCDMTMP SET 
                    MaQuanLy = :MaQuanLy,
        ...
        public static List<GiayCamKetChapNhanTTCDMTMP> GetListData(MDB.MDBConnection MyConnection, decimal MaQuanLy)
        {
            List<GiayCamKetChapNhanTTCDMTMP> lstData = new List<GiayCamKetChapNhanTTCDMTMP>();
            string sql = @"select * from GiayCamKetChapNhanTTCDMTMP WHERE MaQuanLy = :MaQuanLy ";
            ...
            {
                GiayCamKetChapNhanTTCDMTMP data = new GiayCamKetChapNhanTTCDMTMP();
