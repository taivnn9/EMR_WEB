...
{
    public class GiayCamDoanDeoMayHolterDTDHA : ThongTinKy
    {
        public GiayCamDoanDeoMayHolterDTDHA()
        {
            TableName = "GiayCamDoanDeoMayHolterDTDHA";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCDDMHDTDHA;
            TenMauPhieu = DanhMucPhieu.GCDDMHDTDHA.Description();
        }
    ...
    public class GiayCamDoanDeoMayHolterDTDHAFunc
    {
        public const string TableName = "GiayCamDoanDeoMayHolterDTDHA";
        public const string TablePrimaryKeyName = "ID";
        public const string MaPhieu = "GCDDMHDTDHA";

        public static List<GiayCamDoanDeoMayHolterDTDHA> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<GiayCamDoanDeoMayHolterDTDHA> list = new List<GiayCamDoanDeoMayHolterDTDHA>();
            try
            {
                string sql = @"SELECT * FROM GiayCamDoanDeoMayHolterDTDHA where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    GiayCamDoanDeoMayHolterDTDHA data = new GiayCamDoanDeoMayHolterDTDHA();
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref GiayCamDoanDeoMayHolterDTDHA bangKiem)
        {
            try
            {
                string sql = @"INSERT INTO GiayCamDoanDeoMayHolterDTDHA
                (
                    MAQUANLY,
                    MaBenhNhan,
                    MaBenhAn,
                ...
                if (bangKiem.ID != 0)
                {
                    sql = @"UPDATE GiayCamDoanDeoMayHolterDTDHA SET 
                    MAQUANLY = :MAQUANLY,
                ...
                Command.Parameters.Add(new MDB.MDBParameter("HolterName", bangKiem.HolterName));
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM GiayCamDoanDeoMayHolterDTDHA WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
        ...
        public static DataSet getDataSet(MDB.MDBConnection MyConnection, long id)
        {
            string sql = @"SELECT
                *
            FROM
                GiayCamDoanDeoMayHolterDTDHA B
            WHERE
                ID = " + id;
