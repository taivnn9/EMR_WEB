...
{
    public class GiayCamKetChapNhanTTDONKQ : ThongTinKy
    {
        public GiayCamKetChapNhanTTDONKQ()
        {
            TableName = "GiayCamKetChapNhanTTDONKQ";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.GCKCNTTDONKQ;
            TenMauPhieu = DanhMucPhieu.GCKCNTTDONKQ.Description();
        }
    ...
    public class GiayCamKetChapNhanTTDONKQFunc
    {
        public const string TableName = "GiayCamKetChapNhanTTDONKQ";
        public const string TablePrimaryKeyName = "ID";
        public const string MaPhieu = "GCKCNTTDONKQ";

        public static bool Delete(MDB.MDBConnection MyConnection, decimal id)
        {
            try
            {
                string sql = "DELETE FROM GiayCamKetChapNhanTTDONKQ WHERE ID = :ID";
        ...
        {
            string sql = @"select * "
                         + " from GiayCamKetChapNhanTTDONKQ WHERE ID =: ID ORDER BY NgayTao, NgaySua asc";
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, GiayCamKetChapNhanTTDONKQ ketQua)
        {
            try
            {
                string sql = @"INSERT INTO GiayCamKetChapNhanTTDONKQ
                (
                    MaQuanLy,
                    MaBenhNhan,
                    MaBenhAn,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE GiayCamKetChapNhanTTDONKQ SET 
                    MaQuanLy = :MaQuanLy,
        ...
        public static List<GiayCamKetChapNhanTTDONKQ> GetListData(MDB.MDBConnection MyConnection, decimal MaQuanLy)
        {
            List<GiayCamKetChapNhanTTDONKQ> lstData = new List<GiayCamKetChapNhanTTDONKQ>();
            string sql = @"select * from GiayCamKetChapNhanTTDONKQ WHERE MaQuanLy = :MaQuanLy ";
            ...
            {
                GiayCamKetChapNhanTTDONKQ data = new GiayCamKetChapNhanTTDONKQ();
