...
{
    public class BenhAnStentDongMachVanh : IBase
    {
        public int IDMauPhieu { get; set; } = (int)DanhMucPhieu.BASDMV;
        public string TenMauPhieu { get; set; } = DanhMucPhieu.BASDMV.Description();
