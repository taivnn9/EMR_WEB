...
{
    public class NghiemPhapBeck : ThongTinKy
    {
        public NghiemPhapBeck()
        {
            TableName = "NghiemPhapBeck";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.NPB;
            TenMauPhieu = DanhMucPhieu.NPB.Description();
        }
        ...
        public bool[] STT_21_Array { get; } = new bool[] { false, false, false, false };
        public int STT_21
        {
            get
            {
    ...
    public class NghiemPhapBeckFunc
    {
        public const string TableName = "NghiemPhapBeck";
        public const string TablePrimaryKeyName = "ID";
        public static List<NghiemPhapBeck> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<NghiemPhapBeck> list = new List<NghiemPhapBeck>();
            try
            {
                string sql = @"SELECT * FROM NghiemPhapBeck where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    NghiemPhapBeck data = new NghiemPhapBeck();
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref NghiemPhapBeck ketQua)
        {
            try
            {
                string sql = @"INSERT INTO NghiemPhapBeck
                (
                    MAQUANLY,
                    MaBenhNhan,
                    ChanDoan,
        ...
        public static bool delete(MDB.MDBConnection MyConnection, long id)
        {
            try
            {
                string sql = "DELETE FROM NghiemPhapBeck WHERE ID = :ID";
                MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
