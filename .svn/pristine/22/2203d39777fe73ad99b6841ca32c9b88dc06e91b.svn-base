...
{
    public class ThuThuatDatNKQQuaMui : ThongTinKy
    {
        public ThuThuatDatNKQQuaMui()
        {
            TableName = "ThuThuatDatNKQQuaMui";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.PTTTDNKQQMUI;
            TenMauPhieu = DanhMucPhieu.PTTTDNKQQMUI.Description();
        }
        ...
        [MoTaDuLieu("Chẩn đoán sau khi làm thủ thuật")]
        ...
        public string SoOngNKQ { get; set; }
        public string Cruff { get; set; }
        public string CmCoDinh { get; set; }
    ...
    public class ThuThuatDatNKQQuaMuiFunc
    {
        public const string TableName = "ThuThuatDatNKQQuaMui";
        public const string TablePrimaryKeyName = "ID";

        public static List<ThuThuatDatNKQQuaMui> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<ThuThuatDatNKQQuaMui> list = new List<ThuThuatDatNKQQuaMui>();
            try
            {
                string sql = @"SELECT * FROM ThuThuatDatNKQQuaMui where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    ThuThuatDatNKQQuaMui data = new ThuThuatDatNKQQuaMui();
                    ...
                    data.SoOngNKQ = DataReader["SoOngNKQ"].ToString();
                    data.Cruff = DataReader["Cruff"].ToString();
                    data.CmCoDinh = DataReader["CmCoDinh"].ToString();
        ...
        public static bool DeleteByIDPhieu(MDB.MDBConnection oracleConnection, decimal IDBienBan)
        {
            try
            {
                ...
                string sql = @"DELETE FROM ThuThuatDatNKQQuaMui WHERE ID =" + IDBienBan;
        ...
        {
            string sql = @"SELECT P.*, T.SoNhapVien, T.Khoa, T.MaBenhAn, T.MaKhoa, H.BENHVIEN, H.SoYTe,  H.TenBenhNhan, H.Tuoi
			  FROM ThuThuatDatNKQQuaMui P 
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref ThuThuatDatNKQQuaMui ketQua)
        {
            try
            {
                string sql = @"INSERT INTO ThuThuatDatNKQQuaMui
                (
                    MaQuanLy,
                    Buong,
                    Giuong,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE ThuThuatDatNKQQuaMui SET 
                    MaQuanLy = :MaQuanLy,
                    Buong = :Buong,
                    Giuong = :Giuong,
                ...
                Command.Parameters.Add(new MDB.MDBParameter("SoOngNKQ", ketQua.SoOngNKQ));
                Command.Parameters.Add(new MDB.MDBParameter("Cruff", ketQua.Cruff));
                Command.Parameters.Add(new MDB.MDBParameter("CmCoDinh", ketQua.CmCoDinh));
