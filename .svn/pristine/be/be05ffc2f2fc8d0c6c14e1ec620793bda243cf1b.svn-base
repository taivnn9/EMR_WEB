...
namespace EMR_MAIN.DATABASE.Other
{
    ...
    public class PhieuTheoDoiVaChamSocSan : ThongTinKy
    {
        public PhieuTheoDoiVaChamSocSan()
        {
            TableName = "PhieuTDVCSBNSan";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.PTDVCSSAN;
            TenMauPhieu = DanhMucPhieu.PTDVCSSAN.Description();
        }
        ...
        public List<PhieuTheoDoiVaChamSocSan_ChiTiet> TTCSChiTiet { get; set; }
        ...
        public PhieuTheoDoiVaChamSocSan Clone()
        {
            PhieuTheoDoiVaChamSocSan other = (PhieuTheoDoiVaChamSocSan)this.MemberwiseClone();
            other.TTCSChiTiet = new List<PhieuTheoDoiVaChamSocSan_ChiTiet>();
            if (this.TTCSChiTiet != null)
            foreach (PhieuTheoDoiVaChamSocSan_ChiTiet item in this.TTCSChiTiet)
            {
        ...
        public string SoLuongDAD { get; set; }
        public string TinhChatDAD { get; set; }
        public bool[] DauOi_Array { get; } = new bool[] { false, false, false };
        public string DauOi
        {
            get
            {
                string temp = String.Empty;
                for (int i = 0; i < DauOi_Array.Length; i++)
                    temp += (DauOi_Array[i] ? "1" : "0");
                return temp;
            }
            set
            {
                if (value != null)
                {
                    ...
                    {
                        int intTemp = value[i] - '0';
                        DauOi_Array[i] = intTemp == 1 ? true : false;
                    }
                }
            }
        }
    ...
    public class PhieuTheoDoiVaChamSocSan_ChiTiet: ThongTinKy
    {
        [MoTaDuLieu("Mã định danh")]
        ...
        public string DoXoa { set; get; }
        public string TSConCo { set; get; }
        public string TimThai { set; get; }
        ...
        public string YThuc_Khac { set; get; }
        public string DaNiemMac { set; get; }

        public bool[] Dau_Array { get; } = new bool[] { false, false, false, false };
        public string Dau
        {
            get
            {
        ...
        public string SoLuongDAD { set; get; }
        public string TinhChatDAD { set; get; }
        public string DaiTieuTien { set; get; }
        ...
        [MoTaDuLieu("Chọn", null, 0, 0)]
		public bool Chon { get; set; }
        public PhieuTheoDoiVaChamSocSan_ChiTiet Clone()
        {
            PhieuTheoDoiVaChamSocSan_ChiTiet other = (PhieuTheoDoiVaChamSocSan_ChiTiet)this.MemberwiseClone(); 
            return other;
        }
    }
    public class PhieuTheoDoiVaChamSocSanFunc
    {
        static Logger log = LogManager.GetLogger("Log");
        public const string TableName = "PhieuTDVCSBNSan";
        public const string TablePrimaryKeyName = "IDPhieu";

        public static List<ThuocPha> DanhSachThuocPha = new List<ThuocPha>();


        public List<PhieuTheoDoiVaChamSocSan> Select(MDB.MDBConnection MyConnection, string MaQuanLy)
        {
            try
            { 
                { 
                    List<PhieuTheoDoiVaChamSocSan> listResult = new List<PhieuTheoDoiVaChamSocSan>();
                    string sql = @"SELECT t.*
                    FROM PhieuTDVCSBNSan t
                    ...
                    {
                        var obj = new PhieuTheoDoiVaChamSocSan();
                        ...
                        obj.SoLuongThai = Common.ConDBNull(DataReader["SoLuongThai"]);
                        ...
                        obj.TinhChatDAD = Common.ConDBNull(DataReader["TinhChatDAD"]);
                        obj.SoLuongDAD = Common.ConDBNull(DataReader["SoLuongDAD"]);
                        obj.DauOi = Common.ConDBNull(DataReader["DauOi"]);
                        obj.NuocOi = Common.ConDBNull(DataReader["NuocOi"]);
                        ...
                        obj.TTCSChiTiet = new List<PhieuTheoDoiVaChamSocSan_ChiTiet>();
        ...
        public bool Insert(MDB.MDBConnection MyConnection, PhieuTheoDoiVaChamSocSan obj)
        {
            try
            { 
                { 
                    string sql = @"INSERT INTO PhieuTDVCSBNSan (
                    MaQuanLy,
                    TenKhoa,
                    MaKhoa,
                    MaBenhNhan,
                    ...
                    oracleCommand.Parameters.Add(new MDB.MDBParameter("SoLuongThai", obj.SoLuongThai));
                    ...
                    oracleCommand.Parameters.Add(new MDB.MDBParameter("SoLuongDAD", obj.SoLuongDAD));
                    oracleCommand.Parameters.Add(new MDB.MDBParameter("TinhChatDAD", obj.TinhChatDAD));
                    oracleCommand.Parameters.Add(new MDB.MDBParameter("DauOi", obj.DauOi));
                    oracleCommand.Parameters.Add(new MDB.MDBParameter("NuocOi", obj.NuocOi));
        ...
        public bool Update(MDB.MDBConnection MyConnection, PhieuTheoDoiVaChamSocSan obj)
        {
            try
            {
                {

                    string sql = @"UPDATE PhieuTDVCSBNSan SET 
                        MaQuanLy=:MaQuanLy,
                        TenKhoa=:TenKhoa,
                        MaKhoa=:MaKhoa,
                        ...
                        Phu = :Phu,
                        Phu_ViTri = :Phu_ViTri,
                        SoLuongThai = :SoLuongThai,
                        DaNiemMac = :DaNiemMac,
                        Dau = :Dau,
                        ViTriDau = :ViTriDau,
                        MucDoDau = :MucDoDau,
                        TinhChatDau = :TinhChatDau,
                        SoLuongDAD = :SoLuongDAD,
                        TinhChatDAD = :TinhChatDAD,
                        DauOi = :DauOi,
                        NuocOi = :NuocOi,
                        VanDeKhac = :VanDeKhac,
        ...
        public bool Delete(MDB.MDBConnection MyConnection, decimal IDPhieu)
        {
            try
            {
                if (IDPhieu != 0)
                {
                    string sql = @"Delete PhieuTDVCSBNSan 
                                WHERE 
                                (IDPhieu = :IDPhieu) ";
                    MDB.MDBCommand Command = new MDB.MDBCommand(sql, MyConnection);
                    ...
                    Command.Dispose();
                    sql = @"Delete PhieuTDVCSBNSan_ChiTiet 
                                WHERE 
                                (IDPhieu = :IDPhieu) ";
        ...
        public bool Delete_ChiTiet(MDB.MDBConnection MyConnection, decimal IDPhieuCT)
        {
            try
            {
                if (IDPhieuCT != 0)
                {
                    string sql = @"Delete PhieuTDVCSBNSan_ChiTiet 
                                WHERE 
                                (IDPhieuCT = :IDPhieuCT) ";
                    MDB.MDBCommand Command = new MDB.MDBCommand(sql, MyConnection);
        ...
        public static List<PhieuTheoDoiVaChamSocSan_ChiTiet> Select_PhieuCHiTiet(MDB.MDBConnection MyConnection, string IDPhieu, int ModOrder = 0)
        {
            try
            {  
                {
                    List<PhieuTheoDoiVaChamSocSan_ChiTiet> listResult = new List<PhieuTheoDoiVaChamSocSan_ChiTiet>();
                    string sql = @"SELECT t.*
                    FROM PhieuTDVCSBNSan_ChiTiet t
                    ...
                    while (DataReader.Read())
                    {
                        var obj = new PhieuTheoDoiVaChamSocSan_ChiTiet();
                        ...
                        obj.DoXoa = Common.ConDBNull(DataReader["DoXoa"]);
                        obj.TSConCo = Common.ConDBNull(DataReader["TSConCo"]);
        ...
        public bool InsertOrUpdate_ChiTiet(MDB.MDBConnection MyConnection, PhieuTheoDoiVaChamSocSan_ChiTiet obj)
        {
            try
            {
                string sql = @"update PhieuTDVCSBNSan_ChiTiet set
                    IDPhieu=:IDPhieu,
                    ThoiGian=:ThoiGian,
                    NguoiTao=:NguoiTao,
                ...
                oracleCommand.Parameters.Add(new MDB.MDBParameter("DoXoa", obj.DoXoa));
                oracleCommand.Parameters.Add(new MDB.MDBParameter("TSConCo", obj.TSConCo));
                ...
                if (n == 0)
                {
                    ...
                    sql = @"insert into PhieuTDVCSBNSan_ChiTiet (
                    IDPhieu,
                    ThoiGian,
                    NguoiTao,
                    MaNguoiTao,
