...
{
    public class PhieuCBBnTruocPTCuaDDTbl : ThongTinKy
    {
        public PhieuCBBnTruocPTCuaDDTbl()
        {
            TableName = "PhieuCBBnTruocPTCuaDD";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.PCBBNTPTCDD;
            TenMauPhieu = DanhMucPhieu.PCBBNTPTCDD.Description();
        }
        ...
        public string ppPhauThuatDK { get; set; }
        ...
        public DateTime ThoiGianNhinDoi { get; set; }
        public DateTime? ThoiGianNhinDoi_Gio { get; set; }
        ...
        public DateTime? ThoiGianTiemThuoc_Gio { get; set; }
        public string SoLuongMauDT { get; set; }
        ...
        public DateTime? ThoiGianDua_Gio { get; set; }
    ...
    public class PhieuCBBnTruocPTCuaDDFunc
    {
        public static string getBloodABO()
        {
            string bloodABO = "";
            if (XemBenhAn.listChiSoXetNghiem != null && XemBenhAn.listChiSoXetNghiem.Count > 0)
            {
                foreach (ChiSoXetNghiemADO chiSo in XemBenhAn.listChiSoXetNghiem.OrderByDescending(x => x.ExecuteTime))
                {
                    if (chiSo.IsBloodABO)
                    {
                        bloodABO = chiSo.Value;
                        break;
                    }
                }
            }
        ...
        public static string getBloodRH()
        {
            string bloodABO = "";
            if (XemBenhAn.listChiSoXetNghiem != null && XemBenhAn.listChiSoXetNghiem.Count > 0)
            {
        ...
        public static string getBloodHbsAg()
        {
            string bloodABO = "";
            if (XemBenhAn.listChiSoXetNghiem != null && XemBenhAn.listChiSoXetNghiem.Count > 0)
            {
        ...
        public static string getBloodHCV()
        {
            string bloodABO = "";
            if (XemBenhAn.listChiSoXetNghiem != null && XemBenhAn.listChiSoXetNghiem.Count > 0)
            {
        ...
        public static string getBloodHIV()
        {
            string bloodABO = "";
            if (XemBenhAn.listChiSoXetNghiem != null && XemBenhAn.listChiSoXetNghiem.Count > 0)
            {
        ...
        public const string TableName = "PhieuCBBnTruocPTCuaDD";
        public const string TablePrimaryKeyName = "IDPhieu";
        public static List<PhieuCBBnTruocPTCuaDDTbl> GetListData(MDB.MDBConnection MyConnection, decimal MaQuanly)
        {
            try
            {
                {
                    List<PhieuCBBnTruocPTCuaDDTbl> lstObject = new List<PhieuCBBnTruocPTCuaDDTbl>();
                    string sql = "SELECT * FROM PhieuCBBnTruocPTCuaDD   WHERE MaQuanLy = :MaQuanLy ORDER BY IDPhieu DESC";
                    MDB.MDBCommand command = new MDB.MDBCommand(sql, MyConnection);
                    command.Parameters.Add(new MDB.MDBParameter("MaQuanly", MaQuanly));
                    MDB.MDBDataReader DataReader = command.ExecuteReader();
                    while (DataReader.Read())
                    {
                        PhieuCBBnTruocPTCuaDDTbl obj = new PhieuCBBnTruocPTCuaDDTbl();
                        ...
                        obj.PhauThuat = Common.ConDB_Int(DataReader["PhauThuat"]);
                        obj.Diung = Common.ConDB_Int(DataReader["Diung"]);
                        obj.TestThuoc = Common.ConDB_Int(DataReader["TestThuoc"]);
                        ...
                        obj.ppPhauThuatDK = Common.ConDBNull(DataReader["ppPhauThuatDK"]);
                        ...
                        obj.ThoiGianNhinDoi = Common.ConDB_DateTime(DataReader["ThoiGianNhinDoi"]);
                        obj.ThoiGianNhinDoi_Gio = obj.ThoiGianNhinDoi;
                        ...
                        obj.ThoiGianTiemThuoc_Gio = obj.ThoiGianTiemThuoc;
                        obj.SoLuongMauDT = Common.ConDBNull(DataReader["SoLuongMauDT"]);
                        ...
                        obj.ThoiGianDua_Gio = obj.ThoiGianDua;
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection oracleConnection, PhieuCBBnTruocPTCuaDDTbl obj, ref bool isUpdate)
        {
            try
            {
                string sql = @"SELECT COUNT(*) RECNUM FROM PhieuCBBnTruocPTCuaDD WHERE IDPhieu  = :IDPhieu";
                ...
                {
                    isUpdate = true;
                    sql = "update PhieuCBBnTruocPTCuaDD set MaQuanLy=:MaQuanLy,TenBenhNhan=:TenBenhNhan,NamSinh=:NamSinh,GioiTinh=:GioiTinh,ChanDoan=:ChanDoan,Khoa=:Khoa,PhauThuat=:PhauThuat,Diung=:Diung,TestThuoc=:TestThuoc,ChiTietDiung=:ChiTietDiung,MaDDChuanBi=:MaDDChuanBi,TenDDChuanBi=:TenDDChuanBi,MaDDDua=:MaDDDua,TenDDDua=:TenDDDua,MaDDNhan=:MaDDNhan,TenDDNhan=:TenDDNhan,MaBenhNhan=:MaBenhNhan,MaKhoa=:MaKhoa,ppPhauThuatDK=:ppPhauThuatDK,NDI1_1=:NDI1_1,NDI1_2=:NDI1_2,NDI1_3=:NDI1_3,NDI1_4=:NDI1_4,NDI2_1=:NDI2_1,NDI2_2=:NDI2_2,NDI3_1=:NDI3_1,NDI3_2=:NDI3_2,NDI4_1=:NDI4_1,NDI4_2=:NDI4_2,NDI5_1=:NDI5_1,NDI5_2=:NDI5_2,NDI6_1=:NDI6_1,NDI6_2=:NDI6_2,NDI7_1=:NDI7_1,NDI7_2=:NDI7_2,NDI8_1=:NDI8_1,NDI8_2=:NDI8_2,NDI9_1=:NDI9_1,NDI9_2=:NDI9_2,NDI9_3=:NDI9_3,NDI9_4=:NDI9_4,NDI9_5=:NDI9_5,NDI9_6=:NDI9_6,NDI10_1=:NDI10_1,NDI10_2=:NDI10_2,NDI11_1=:NDI11_1,NDI11_2=:NDI11_2,NDI11_3=:NDI11_3,NDI11_4=:NDI11_4,NDII1_1=:NDII1_1,NDII1_2=:NDII1_2,NDII2_1=:NDII2_1,NDII2_2=:NDII2_2,NDII3_1=:NDII3_1,NDII3_2=:NDII3_2,NDII4_1=:NDII4_1,NDII4_2=:NDII4_2,NDII5_1=:NDII5_1,NDII5_2=:NDII5_2,NDII5_3=:NDII5_3,NDII5_4=:NDII5_4,NDII5_5=:NDII5_5,NDII5_6=:NDII5_6,NDII5_7=:NDII5_7,NDII5_8=:NDII5_8,NDII5_9=:NDII5_9,NDII5_10=:NDII5_10,NDII5_11=:NDII5_11,NDII5_12=:NDII5_12,NDII6_1=:NDII6_1,NDII6_2=:NDII6_2,NDII6_3=:NDII6_3,NDII6_4=:NDII6_4,NDII6_5=:NDII6_5,NDII6_6=:NDII6_6,NDII6_7=:NDII6_7,NDII6_8=:NDII6_8,SoLuongRang=:SoLuongRang,LoaiThucAn=:LoaiThucAn,ThoiGianAn=:ThoiGianAn,ThoiGianNhinDoi=:ThoiGianNhinDoi,HuyetHoc=:HuyetHoc,HbsAg=:HbsAg,HCV=:HCV,HIV=:HIV,XetNghiem=:XetNghiem,ChupChieuKhac=:ChupChieuKhac,ThoiGianTiemThuoc=:ThoiGianTiemThuoc,SoLuongMauDT=:SoLuongMauDT,ThuocTM=:ThuocTM,Mach=:Mach,HAText=:HAText,NhipTho=:NhipTho,NhietDo=:NhietDo,CanNang=:CanNang,ChieuCao=:ChieuCao,BMI=:BMI,ThoiGianDua=:ThoiGianDua,NgayTao=:NgayTao,NguoiTao=:NguoiTao,NgaySua=:NgaySua,NguoiSua=:NguoiSua, TestCovidNhanh=:TestCovidNhanh, TestPCR=:TestPCR ";
                    sql = sql + " WHERE IDPhieu  = " + obj.IDPhieu.ToString();
                }
                else
                {
                    sql = @"insert into PhieuCBBnTruocPTCuaDD(MaQuanLy,TenBenhNhan,NamSinh,GioiTinh,ChanDoan,Khoa,PhauThuat,Diung,TestThuoc,ChiTietDiung,MaDDChuanBi,TenDDChuanBi,MaDDDua,TenDDDua,MaDDNhan,TenDDNhan,MaBenhNhan,MaKhoa,ppPhauThuatDK,NDI1_1,NDI1_2,NDI1_3,NDI1_4,NDI2_1,NDI2_2,NDI3_1,NDI3_2,NDI4_1,NDI4_2,NDI5_1,NDI5_2,NDI6_1,NDI6_2,NDI7_1,NDI7_2,NDI8_1,NDI8_2,NDI9_1,NDI9_2,NDI9_3,NDI9_4,NDI9_5,NDI9_6,NDI10_1,NDI10_2,NDI11_1,NDI11_2,NDI11_3,NDI11_4,NDII1_1,NDII1_2,NDII2_1,NDII2_2,NDII3_1,NDII3_2,NDII4_1,NDII4_2,NDII5_1,NDII5_2,NDII5_3,NDII5_4,NDII5_5,NDII5_6,NDII5_7,NDII5_8,NDII5_9,NDII5_10,NDII5_11,NDII5_12,NDII6_1,NDII6_2,NDII6_3,NDII6_4,NDII6_5,NDII6_6,NDII6_7,NDII6_8,SoLuongRang,LoaiThucAn,ThoiGianAn,ThoiGianNhinDoi,HuyetHoc,HbsAg,HCV,HIV,XetNghiem,ChupChieuKhac,ThoiGianTiemThuoc,SoLuongMauDT,ThuocTM,Mach,HAText,NhipTho,NhietDo,CanNang,ChieuCao,BMI,ThoiGianDua,NgayTao,NguoiTao,NgaySua,NguoiSua, TestCovidNhanh, TestPCR " +
                        ")";
                    sql = sql + @"Values(:MaQuanLy,:TenBenhNhan,:NamSinh,:GioiTinh,:ChanDoan,:Khoa,:PhauThuat,:Diung,:TestThuoc,:ChiTietDiung,:MaDDChuanBi,:TenDDChuanBi,:MaDDDua,:TenDDDua,:MaDDNhan,:TenDDNhan,:MaBenhNhan,:MaKhoa,:ppPhauThuatDK,:NDI1_1,:NDI1_2,:NDI1_3,:NDI1_4,:NDI2_1,:NDI2_2,:NDI3_1,:NDI3_2,:NDI4_1,:NDI4_2,:NDI5_1,:NDI5_2,:NDI6_1,:NDI6_2,:NDI7_1,:NDI7_2,:NDI8_1,:NDI8_2,:NDI9_1,:NDI9_2,:NDI9_3,:NDI9_4,:NDI9_5,:NDI9_6,:NDI10_1,:NDI10_2,:NDI11_1,:NDI11_2,:NDI11_3,:NDI11_4,:NDII1_1,:NDII1_2,:NDII2_1,:NDII2_2,:NDII3_1,:NDII3_2,:NDII4_1,:NDII4_2,:NDII5_1,:NDII5_2,:NDII5_3,:NDII5_4,:NDII5_5,:NDII5_6,:NDII5_7,:NDII5_8,:NDII5_9,:NDII5_10,:NDII5_11,:NDII5_12,:NDII6_1,:NDII6_2,:NDII6_3,:NDII6_4,:NDII6_5,:NDII6_6,:NDII6_7,:NDII6_8,:SoLuongRang,:LoaiThucAn,:ThoiGianAn,:ThoiGianNhinDoi,:HuyetHoc,:HbsAg,:HCV,:HIV,:XetNghiem,:ChupChieuKhac,:ThoiGianTiemThuoc,:SoLuongMauDT,:ThuocTM,:Mach,:HAText,:NhipTho,:NhietDo,:CanNang,:ChieuCao,:BMI,:ThoiGianDua,:NgayTao,:NguoiTao,:NgaySua,:NguoiSua, :TestCovidNhanh, :TestPCR" +
                ...
                oracleCommand.Parameters.Add(new MDB.MDBParameter("PhauThuat", obj.PhauThuat));
                oracleCommand.Parameters.Add(new MDB.MDBParameter("Diung", obj.Diung));
                oracleCommand.Parameters.Add(new MDB.MDBParameter("TestThuoc", obj.TestThuoc));
                ...
                oracleCommand.Parameters.Add(new MDB.MDBParameter("ppPhauThuatDK", obj.ppPhauThuatDK));
                ...
                DateTime? NgayNhinDoi = obj.ThoiGianNhinDoi;
                var NgayGio = NgayNhinDoi;
                if (NgayNhinDoi != null)
                {
                    var Gio = obj.ThoiGianNhinDoi_Gio.HasValue ? obj.ThoiGianNhinDoi_Gio.Value.TimeOfDay : new TimeSpan(0, 0, 0);
                    NgayGio = NgayNhinDoi + Gio;
                }
                oracleCommand.Parameters.Add(new MDB.MDBParameter("ThoiGianNhinDoi", NgayGio));
                ...
                DateTime? ThoiGianTiemThuoc = obj.ThoiGianTiemThuoc;
                NgayGio = ThoiGianTiemThuoc;
                if (ThoiGianTiemThuoc != null)
                {
                    var Gio = obj.ThoiGianTiemThuoc_Gio.HasValue ? obj.ThoiGianTiemThuoc_Gio.Value.TimeOfDay : new TimeSpan(0, 0, 0);
                    NgayGio = ThoiGianTiemThuoc + Gio;
                }
                oracleCommand.Parameters.Add(new MDB.MDBParameter("ThoiGianTiemThuoc", NgayGio));
                oracleCommand.Parameters.Add(new MDB.MDBParameter("SoLuongMauDT", obj.SoLuongMauDT));
                ...
                DateTime? ThoiGianDua = obj.ThoiGianDua;
                NgayGio = ThoiGianDua;
                if (ThoiGianDua != null)
                {
                    var Gio = obj.ThoiGianDua_Gio.HasValue ? obj.ThoiGianDua_Gio.Value.TimeOfDay : new TimeSpan(0, 0, 0);
                    NgayGio = ThoiGianDua + Gio;
                }
                oracleCommand.Parameters.Add(new MDB.MDBParameter("ThoiGianDua", NgayGio));
        ...
        public static bool DeleteByIDPhieu(MDB.MDBConnection oracleConnection, List<decimal> lstIDbienBan)
        {
            try
            {
                ...
                sql = @"DELETE FROM PhieuCBBnTruocPTCuaDD WHERE  " + strWhere;
