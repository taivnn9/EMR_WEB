...
{
    public class ThuThuatDatCatheterDM : ThongTinKy
    {
        public ThuThuatDatCatheterDM()
        {
            TableName = "ThuThuatDatCatheterDM";
            TablePrimaryKeyName = "ID";
            IDMauPhieu = (int)DanhMucPhieu.PTTTDCDM;
            TenMauPhieu = DanhMucPhieu.PTTTDCDM.Description();
        }
        ...
        public string DongMach { get; set; }
    ...
    public class ThuThuatDatCatheterDMFunc
    {
        public const string TableName = "ThuThuatDatCatheterDM";
        public const string TablePrimaryKeyName = "ID";

        public static List<ThuThuatDatCatheterDM> GetListData(MDB.MDBConnection _OracleConnection, decimal maquanly)
        {
            List<ThuThuatDatCatheterDM> list = new List<ThuThuatDatCatheterDM>();
            try
            {
                string sql = @"SELECT * FROM ThuThuatDatCatheterDM where MaQuanLy = :MaQuanLy";
                MDB.MDBCommand Command = new MDB.MDBCommand(sql, _OracleConnection);
                Command.Parameters.Add(new MDB.MDBParameter("MaQuanLy", maquanly));
                MDB.MDBDataReader DataReader = Command.ExecuteReader();
                while (DataReader.Read())
                {
                    ThuThuatDatCatheterDM data = new ThuThuatDatCatheterDM();
                    ...
                    data.DongMach = DataReader["DongMach"].ToString();
        ...
        public static bool DeleteByIDPhieu(MDB.MDBConnection oracleConnection, decimal IDBienBan)
        {
            try
            {
                ...
                string sql = @"DELETE FROM ThuThuatDatCatheterDM WHERE ID =" + IDBienBan;
        ...
        public static bool InsertOrUpdate(MDB.MDBConnection MyConnection, ref ThuThuatDatCatheterDM ketQua)
        {
            try
            {
                string sql = @"INSERT INTO ThuThuatDatCatheterDM
                (
                    MaQuanLy,
                    Buong,
                    Giuong,
                ...
                if (ketQua.ID != 0)
                {
                    sql = @"UPDATE ThuThuatDatCatheterDM SET 
                    MaQuanLy = :MaQuanLy,
                    Buong = :Buong,
                    Giuong = :Giuong,
                ...
                Command.Parameters.Add(new MDB.MDBParameter("DongMach", ketQua.DongMach));
