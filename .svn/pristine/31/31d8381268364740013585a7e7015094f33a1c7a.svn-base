...
{
    public class BenhAnMat : BenhAnBase, IBase
    {
        public int IDMauPhieu { get; set; } = (int)DanhMucPhieu.BAM;
        public string TenMauPhieu { get; set; }= DanhMucPhieu.BAM.Description();
